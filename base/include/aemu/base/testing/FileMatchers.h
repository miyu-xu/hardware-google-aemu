 ...
 *   std::filesystem::path path5 = "C:/MyFolder/file.txt";
 *   std::filesystem::path path6 = "C:/myfolder/file.txt";
 *   EXPECT_THAT(path5, testing::Not(testing::PathEq(path6))); // Should pass (case-sensitive)
 * }
 * @endcode
 */
